...
{
   // creating objects
   ClockType myclock(23,45,59);
   ClockType yourclock(23,59,33);
 ...
 //  myclock.setTime(5, 50, 6);
  ...
  // yourclock.setTime(5, 50, 6);
   ...
   yourclock.increment_minutes();
   cout<<"\nAfter incrementing myclock time: ";
   myclock.print_time();
   cout<<"\nAfter incrementing yourclock time: ";
   yourclock.print_time();
   cout<<endl;
   cout<<"checking again time: "<<endl;
   if (myclock.equalTime(yourclock))
   {
